...
//import com.dans.tms.repo.UserRepo;
//import com.dans.tms.service.UserService;
//import com.dans.tms.util.JWTUtil;
...
//
//    public TokenFilter(List<RequestMatcher> antMatchers, JWTUtil jwtUtil, UserService userService, UserRepo userRepo) {
...
//                var userOptional = userService.getUserById(UUID.fromString(id));
//
...
//                var authorities = List.of(new SimpleGrantedAuthority(user.getRoleCode()));
